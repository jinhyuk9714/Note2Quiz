...
function ShareDialogInner({ quizId, onClose }: ShareDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ref={dialogRef}
        className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-xl animate-in zoom-in-95 fade-in duration-200"
      >
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-base font-bold text-slate-800">퀴즈 공유</h2>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-slate-700">공유 활성화</p>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-600 font-mono truncate"
                    />
                    <button
